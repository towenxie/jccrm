...
================================================================================ */
/**
 * The request functionality for sliders like the volume bar and seek bar
 *
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Run request component initializing with new options.
...
/**
 * The request class for all text tracks
 *
...
/**
 * The request class for buttons that toggle specific text track types (e.g. subtitles)
 *
 * @constructor
 */
