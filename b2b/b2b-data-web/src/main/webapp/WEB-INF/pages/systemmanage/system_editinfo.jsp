		...
		<form class="form-horizontal" id="sysuser" action="" accept-charset="UTF-8"
			...
			<div class="form-body">
				<div class="form-group">
					...
					<div class="col-xs-4">
						<input class="form-control"  value="${sysuser.username}"  name="username" type="text">
					</div>
					<label class="control-label col-xs-2"> <label ><span
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<select class="form-control" name="deptCode">
							<c:forEach items="${depts}" var="d">
								<option ${sysuser.deptCode ?'selected':''} value="${d.code}">${d.name}</option>
							</c:forEach>
						</select>
					</div>
					<label class="control-label col-xs-2"> <label ><span
					...
					<div class="col-xs-4">
						<input class="form-control"  value="${sysuser.parentWorkId}"  name="parentWorkId" type="text">
					</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<select class="form-control" name="roleCodes" multiple="multiple">
