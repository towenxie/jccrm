...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="${context }/main"><i class="fa">
            <img src="${context }/static/dist/img/home_ico.png" width="10" height="10"></i>首页</a></li>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <input class="form-control" value="${orderId}" name="orderId" placeholder="" type="text">
                            </div>
                        </div>
                        &nbsp;&nbsp;
                        <div class="form-group">
                        ...
                        <c:forEach items="${page.results }" var="result" varStatus="status">
                            <tr>
                                ...
                                <td><a href="#" class="btn btn-primary btn-xs" id="student-bj"
                                       onclick="handle('${result.id}')">处理</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
...
<script type="text/javascript">
    function handle(id) {
        $.ajax({
            url: "${context}/complain/handle?id=" + id,
            dataType: "html",
    ...
    function queryResult() {
        $.ajax({
            url: "${context}/complain/list?complainStat=0&pageNo=" + $("#pageNo").val(),
    ...
    function initResult() {
        $.ajax({
            url : "${context}/complain/list?complainStat=0&pageNo=1",
            data : $("#searchForm").serialize(),
            type : "post",
            dataType : 'html',
            success : function(data) {
