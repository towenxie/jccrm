...
<!-- 						</div> -->
						...
						<input name="orderDept" type="hidden" value="" />
							...
							<c:forEach items="${page.results}" var="sys">
								<tr>
									...
									<td style="width: 100px;">
										<a href="#" class="btn btn-primary btn-xs" id="student-bj" onclick="editOrder('${sys.orderNumber}')">编辑</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
...
<script type="text/javascript">
	function queryResult(){
		$.ajax({
			url:'${context}/ordermanage/myorder/querybypage',
			type:'post',
...
// 		ele.src = '${context}/ordermanage/packageorder/export?ordernum='+orderNum;
	...
	function editOrder(orderNum){
		 $.ajax({
			url:'${context}/ordermanage/myorder/updateinit',
			type:'post',
