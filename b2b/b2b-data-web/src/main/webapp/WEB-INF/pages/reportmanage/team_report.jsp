...
<script type="text/javascript" src="${context}/static/plugins/echart/echarts.min.js"></script>
...
queryResult();
	function queryResult() { //Ajax方式动态获取json格式数据
	    $.ajax({
	        ...
	        url: "${context}/reportmanage/loadreportbyteam",
